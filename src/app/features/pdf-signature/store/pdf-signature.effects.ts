...
export class PdfSignatureEffects {
  ...
  constructor(private readonly actions$: Actions, private readonly store: Store, private readonly pdfSignatureService: PdfSignatureService) {}
}
